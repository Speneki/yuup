...
user2 = User.create(firstName: "George", lastName: Faker::Name.last_name, email: Faker::Internet.email,
    location: 43199, password: 'password')
...
user3 = User.create(firstName: "Connor", lastName: Faker::Name.last_name, email: Faker::Internet.email,
    location: 11223, password: 'password')
...
user4 = User.create(firstName: "Brandon", lastName: Faker::Name.last_name, email: Faker::Internet.email,
    location:14602, password: 'password')
...
user5 = User.create(firstName: "Daniel", lastName: Faker::Name.last_name, email: Faker::Internet.email,
    location: 87001, password: 'password')

user5.photo.attach(io: File.open("./app/assets/images/people/pic6.jpg"), filename: "profpic.jpeg")
user6 = User.create(firstName: "Bryan", lastName: "Santos", email: "coolbryan@gmail.com",
    location: 10460, password: 'password')
...
Review.create!(user_id: user1.id, business_id: biz2.id, rating: Faker::Number.between(from: 3, to: 5), body: Faker::TvShows::Simpsons.quote )
Review.create!(user_id: user1.id, business_id: biz3.id, rating: Faker::Number.between(from: 3, to: 5), body: Faker::TvShows::Simpsons.quote )
Review.create!(user_id: user1.id, business_id: biz4.id, rating: Faker::Number.between(from: 1, to: 5), body: Faker::TvShows::Simpsons.quote )
...
Review.create!(user_id: user4.id, business_id: biz1.id, rating: 5, body: Faker::TvShows::HowIMetYourMother.quote)

Review.create!(user_id: user5.id, business_id: biz1.id, rating: 4, body: Faker::TvShows::HowIMetYourMother.quote)
Review.create!(user_id: user5.id, business_id: biz2.id, rating: Faker::Number.between(from: 1, to: 2), body: Faker::TvShows::HowIMetYourMother.quote)
...
Review.create!(user_id: user6.id, business_id: biz3.id, rating: Faker::Number.between(from: 3, to: 5), body: Faker::Quotes::Shakespeare.king_richard_iii_quote)
Review.create!(user_id: user6.id, business_id: biz4.id, rating: Faker::Number.between(from: 1, to: 5), body: Faker::Quotes::Shakespeare.king_richard_iii_quote)
